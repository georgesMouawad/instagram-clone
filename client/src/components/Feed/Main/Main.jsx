...
const Main = () => {
    return (
        <div className="feed-main flex column center">
            <div className="post-container flex column center">
                <div className="post-header flex center space-between">
                    <div className="post-header-left flex center">
                        ...
                        <p className="size-m black-text">Username <span className='light-text'> 1d</span></p>
                    </div>
                ...
                <div className="post-likes">
                    <p className="black-text size-m bold">999 <span>likes</span></p>
                </div>
                <div className="post-caption">
                    <p className="size-m black-text bold">Username <span className='light-text regular'>Caption</span></p>
                </div>
                <div className="post-comments">
                    <p className="size-m black-text bold">Username <span className='light-text regular'>Comment</span></p>
                    <p className="size-m black-text bold">Username <span className='light-text regular'>Comment</span></p>
                </div>
